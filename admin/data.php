...
?>
	<div class="container">
		...
		<ul class="nav navbar-nav navbar-right">
			<a href="tambah.php" data-toggle="tooltip" title="Tambah Data Mahasiswa" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-user"></span> Tambah Data</a>
		</ul>
		</div>
			<br />
						...
						while($row = mysqli_fetch_assoc($sql))
						{
							...
							<tr>
								...
								if($row['kelas'] == 'Regular'){
									echo '<span>17.8A.33</span>';
								}
								else if ($row['kelas'] == 'Karyawan' ){
									echo '<span>17.8B.33</span>';
								}
								
								else if($row['mata_kuliah'] == 'Web'){
									echo '<span>Web</span>';
								}
								else if ($row['mata_kuliah'] == 'Jarkom' ){
									echo '<span>Jarkom</span>';
								}
